...
<template>
  ...
  >
    ...
    >
      <div
        class="flex flex-col max-w-3xl mx-auto my-12 p-4 gap-4 bg-gray-200 dark:bg-gray-900 dark:text-white border-[3px] dark:border-gray-700 rounded-2xl"
        :class="{
          'border-red-500': borderColor === 'red',
          'border-green-500': borderColor === 'green',
          'border-gray-300': !borderColor || borderColor === 'gray',
        }"
      >
        <slot></slot>
      </div>
